  ...
  let content = [
    {
      ...
      content: `The battle to protect a sophisticated, more than a 1,000-year-old language was just one aspect of the language movement. Fighting for social and economic fairness was the goal. a struggle to preserve one's own individuality when government steps were being taken to stifle it. A battle fought by regular individuals who only wanted to survive. Women and children are fighting for the ability of future generations to say 'moder gorob, moder aasha, a'mori Bangla bhasha. The Bengali language, also known as Bangla, plays a significant role in the history of Bengali speakers all over the world. In fact, Bangla is closely associated with the origins of modern-day Bangladesh. Bangla is currently the sixth most widely spoken language in the world.`
    },

    {
      name: 'P_2',
      title: 'The provincial election victory of the United Front in 1954',
      content: `East Bengal's first provincial general election for the East Bengal Legislative Assembly was contested and won by a combination of political parties known as the United Front. 
      ...
      A 27-year-old young Turk from the United Front defeated Nurul Amin in a resounding loss that virtually ended the Muslim League from East Pakistan's political scene at the time. In the 309-member legislature, United Front parties won easily and picked up 223 seats. With 143 seats, the Awami League won the majority position. 
      `
    },

    {
      ...
      content: `Bangladesh's Constitution is the country's highest law. The text lays forth the foundation for the Bangladeshi republic, which includes a unitary, parliamentary democracy, an independent judiciary, a democratic local government, and a national bureaucracy. It also enshrines fundamental human rights and freedoms. 
    ...
    },
    {
      ...
      content: `Ayub Khan, the country's then-president, established a panel in 1959 to develop a framework for national education strategy, with SM Sharif serving as its secretary of education.
    ...
    },
    {
      ...
      content: `The Six-Point Programme is a list of requests made by the Awami League to terminate the internal colonial control of West Pakistan in East Bengal and eliminate inequality between the two wings of Pakistan.
    ...
    },
    {
      ...
      content: `Student rebellion in 1968 against Pakistani President Ayub Khan's authoritarian government served as the catalyst for the 1969 Mass Upsurge. Peasants, craftsmen, and labourers rapidly joined the movement nearly in unison, and it eventually included the entirety of then-East Pakistan. 
...

    {
      ...
      content: `The War of Independence, which started on March 26, 1971, came to a conclusion on December 16, 1971, with the liberation of Bangladesh. The armed conflict was the result of a string of occurrences, circumstances, and problems that had been causing East and West Pakistan's ties to steadily deteriorate. 
      ...
      <div ref={app} className="main-wrap">
        ...
        <div className='wrapper' >
          ...
          <div className={`canvas-wrapper ${show ? 'canvas-left' : ''}`} >
            <Canvas resize={{ debounce: 0 }} dpr={[1, 2]} style={{ width: width, height: height }}
              shadows className='fadeIn' camera={{ fov: 40 }} gl={{ antialias: true }}>
  ...
  return <>
    ...
    <div className="side-bar-holder">
      <div className="side-bar-wrap">
        ...
        <h1 className='side-nav-title'>{props.activeContent.title}</h1>
        <div className="side-nav-body">
          <ul>
            <li className='content'>
              <p>{props.activeContent.content}</p>
            </li>
          </ul>
        </div>
      </div>
...
function VideoText(props) {
  ...
  return (
    <Text font="/Inter-Bold.woff" fontSize={10} {...props} color={'lightgrey'} >
      CODESIGN
